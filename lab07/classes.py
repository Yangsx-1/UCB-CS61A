...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        newlist = list(filter(lambda card : card.attack != other_card.attack and card.defense != other_card.defense, opponent.deck.cards))
        opponent.deck.cards = newlist
