...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        return False
    gcd = 0
    min_one = player_score if player_score < opponent_score else opponent_score
    i = 1
    while i <= min_one:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while is_continue:
        if who == 0:
            tmp0 = take_turn(strategy0(score0, score1), score1, dice)
            score0 += tmp0
            ...
            tmp1 = take_turn(strategy1(score1, score0), score0, dice)
            score1 += tmp1
            say = say(score0, score1)
            if score1 >= goal:
                is_continue = False
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who:
            ...
            local_score = score0
        diff = local_score - last_score
        if diff > running_high:
            print(diff, "point(s)! The most yet for Player", who)
            return announce_highest(who, local_score, diff)
        else:
            return announce_highest(who, local_score, running_high)
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average(*args):
        total_score = 0
        roll_count = 0
        while roll_count < trials_count:
            one_turn = original_function(*args)
            total_score += one_turn
            roll_count += 1
        avg_score = total_score / roll_count
        return avg_score
    return average
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    i = 1
    max_score = 0
    max_score_roll_num = 0
    while i <= 10:
        avg_func = make_averaged(roll_dice, trials_count)
        tmp = avg_func(i, dice)
        if tmp > max_score:
            max_score_roll_num = i
            max_score = tmp
        i += 1
    return max_score_roll_num
    # END PROBLEM 9
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score + free_bacon_score, opponent_score):
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    extra_ = extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6)
    if extra_ == 0:
        return 0
    else:
        return extra_
